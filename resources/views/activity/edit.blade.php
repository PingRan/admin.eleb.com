...
@section('content')
    ...
    <form class="form-horizontal" action="{{route('activities.update',['activity'=>$activity])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="date" name="end_time" value="{{date('Y-m-d',$activity->end_time)}}">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="inputPassword7" class="col-sm-2 control-label">活动结束时间</label>
            <div class="col-sm-10">
                <textarea id="container" name="content"  style="height: 300px;">{{$activity->content}}</textarea>
            </div>
        </div>
